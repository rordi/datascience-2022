# ---------------------------------------------------------------------
# Assignment 1 - REGRESSION - PREPROCESS & EXPERIMENT
# ---------------------------------------------------------------------
#
# Group A2
...
df_raw<-df_raw[sample(1:nrow(df_raw)), ]
...
# write.csv(df, "./LCdata_0_dropped.csv")
...
write.csv(df_selection, "./LCdata_preprocessed.csv", row.names = FALSE)
